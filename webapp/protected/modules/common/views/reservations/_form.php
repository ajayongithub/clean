...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->dropDownList($model, 'user_id', GxHtml::listDataEx(::model()->findAllAttributes(null, true))); ?>
		<?php echo $form->error($model,'user_id'); ?>
		</div><!-- row -->
		<div class="row">
		<?php echo $form->labelEx($model,'schedule_id'); ?>
		<?php echo $form->dropDownList($model, 'schedule_id', GxHtml::listDataEx(::model()->findAllAttributes(null, true))); ?>
