...
abstract class BaseProfile extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('id, user_id, timestamp, privacy, lastname, firstname, show_friends, allow_comments, email, street, city, about, initials, telephone_work, telephone_private, address_zipcode, company_name, company_address, company_zipcode, company_city, car_make, car_model, car_color, car_type, car_lease_company, car_number_plate, company_id, location_id, bank_account, profile_complete_status, country, bank_name,username', 'safe', 'on'=>'search'),
		);
	}
	...
	public function setUsername($value){
		Yii::log("setting username to value".$value) ;
