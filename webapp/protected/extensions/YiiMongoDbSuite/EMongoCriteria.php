...
class EMongoCriteria extends CComponent
{
	...
	public function __construct($criteria=null)
	{
		if(is_array($criteria))
		{
			...
			$criteria = $this;
			Yii::log("EmongoCriteria.findAll.criteria.native :".CVarDumper::dumpAsString($criteria->native) , CLogger::LEVEL_INFO);
				Yii::log("EmongoCriteria.findAll.criteria.getSort :".CVarDumper::dumpAsString($criteria->getSort()) , CLogger::LEVEL_INFO);
				Yii::log("EmongoCriteria.findAll.criteria.getLimit :".CVarDumper::dumpAsString($criteria->getLimit()), CLogger::LEVEL_INFO );
				Yii::log("EmongoCriteria.findAll.criteria.getOffset :".CVarDumper::dumpAsString($criteria->getOffset()), CLogger::LEVEL_INFO );
