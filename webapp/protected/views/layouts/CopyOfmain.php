...
<div id="globalWrapper">
  ...
  <header id="mainHeader" class="clearfix" >
          ...
          <div class="row-fluid">
            <div class="span6 clearfix">
              <ul class="quickMenu">
                ...
                <li><span id="logged">Hello John Doe <span class="badge badge-info">3</span></span></li>
              </ul>
            </div>
            <div class="span6 clearfix">
    ...
    <div class="navbar navbar-fixed-top "  >
      <div class="navbar-inner" >
        <div class="container"> <a href="index.php" class="brand"><img src="<?php echo Yii::app()->baseUrl;?>/images/main-logo.png" alt="snowflake"/></a>
          <nav id="mainMenu">
            <ul>
              <li><a href="<?php echo Yii::app()->baseUrl;?>/index.php" id='home' class="firstLevel " >Home</a> </li>
              <li> <a href="<?php echo Yii::app()->baseUrl;?>/view/services" id='services' class="firstLevel">Our Services</a>
              <li> <a href="<?php echo Yii::app()->baseUrl;?>/view/services" id='services' class="firstLevel">Sustainability </a>
                <ul>
                      <li><a href="<?php echo Yii::app()->baseUrl;?>/view/footprint">Wash Footprint</a></li>
                      <li><a href="<?php echo Yii::app()->baseUrl;?>/view/waterImportance">Importance of Water </a></li>
                      <li><a href="<?php echo Yii::app()->baseUrl;?>/view/saveWater">Water Saving Tips</a></li>
                </ul>
              </li>
              <!--  <li> <a href="<?php echo Yii::app()->baseUrl;?>/view/about" id='philosophy' class="firstLevel">About Us</a>
              </li>-->
              <li><a href="<?php echo Yii::app()->baseUrl?>/view/explained" id='explained' class="firstLevel">YClean Explained</a>
              </li>
  ...
  <!--<section id="mainFooter">
	...
	<section class="center-align">	
 		   <div class="container">	
   <div class="link"> <a href="<?php echo Yii::app()->baseUrl?>/view/about">About Us</a> <a href="<?php echo Yii::app()->baseUrl;?>/view/termsconditions">Terms and conditions</a> <a href="<?php echo Yii::app()->baseUrl?>/view/faq">FAQ</a> <a  href="<?php echo Yii::app()->baseUrl?>/view/contact">Contact Us</a> 
   <a href="#">Sitemap</a>
    </div>
