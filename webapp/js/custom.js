...
window.onload = function () { gaSSDSLoad("UA-44426986-1");
...
function initialize(id) {
    ...
    var overlayTitle = 'YClean';

    var locations = [
        //point number 1
        //Amsterdam Tourist & Convention Board De Ruyterkade 5 1013 AA Amsterdam 
        ['YClean B.V.' , 'De Entree, Amsterdam Zuidoost, 1101 BH'],
        //point number 2
